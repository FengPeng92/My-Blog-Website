...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form action="${contextPath}/admin/uploadArticle.htm" method="post">
                <p><button type="button" class="btn btn-lg btn-light">返回列表</button>&nbsp;&nbsp;<button class="btn btn-lg btn-dark" type="submit">提交博客</button></p>
                <div class="col-md-12">
