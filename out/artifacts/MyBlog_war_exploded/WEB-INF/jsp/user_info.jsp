            ...
            <article class="post post-1">
                <header class="entry-header">
                    ...
                    <div class="entry-meta">
                        <span class="post-date"><time class="entry-date">${article.time}</time></span>
                        <span class="post-author">${article.user.username}</span>
                        <span class="comments-link">${article.comments.size()} comments</span>
                        <span class="views-count">${article.praises.size()} likes</span>
                    </div>
                </header>
                <div class="entry-content clearfix">
                    <div class="read-more cl-effect-14">
                        <a href="${contextPath}/user/${article.id}/userViewArticle.htm" class="more-link">View the Article<span class="meta-nav">→</span></a>
                    </div>
                </div>
            </article>
        </c:forEach>
