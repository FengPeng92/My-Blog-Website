                        ...
                        <c:choose>
                            ...
                            <c:when test="${sessionScope.user != null}">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="${contextPath}/user/${sessionScope.user.id}/unreadComment.htm">Comment</a>
<%--                                        <c:if test="${sessionScope.user  > 0}">--%>
<%--                                            <span class="badge badge-light">${sessionScope.user.unreadComment}</span>--%>
<%--                                        </c:if>--%>
                                    </li>
            ...
            <div class="table-responsive">
                <form action="${contextPath}/user/${sessionScope.user.id}/userEdit.htm" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="${sessionScope.user.username}" id="exampleInputEmail1" name="username" aria-describedby="emailHelp">
                        <p>${usernameExisted}</p>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail2">Email</label>
                        <input type="email" class="form-control" value="${sessionScope.user.email}" id="exampleInputEmail2" name="email" aria-describedby="emailHelp">
                        <p>${emailExisted}</p>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password" class="form-control" value="${sessionScope.user.pass}" id="exampleInputPassword1" name="password">
                    </div>
